...
rather than deleting them. Expand the complete current state at 90%, 95% and 98% context
usage without deleting earlier records, so nothing is lost to compression.
